...
public class Parser {
	...
	public static boolean sendToAll(String format, Object... params) {
		return sendToPlayers(Bukkit.getOnlinePlayers(), format, params);
	}

	public static boolean sendToPlayers(Collection<? extends CommandSender> targetPlayers, String format, Object... params) {
		try {
